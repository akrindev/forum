  ...
  <div class="box box-danger">
    <div class="box-body"><strong>Please <a href="/login">Login</a> to add data</strong></div>
      ...
      <div class="box box-primary">
        <div class="box-body">
          <?=form_open_multipart('guild/create');?>
          
          <div class="form-group">
          <label>Guild name</label>
            <input type="text" class="form-control" name="name" placeholder="Name of your guild" value="<?=set_value('name');?>">
         ...
         <?=form_error('members','<span class="text-danger">','</span>');?>
          </div>
           
          <div class="form-group">
          <label>Slogan</label>
            <textarea name="slogan" id="sloga" class="form-control" row="5" placeholder="Guild signature"><?=set_value('slogan');?></textarea>
       <?=form_error('slogan','<span class="text-danger">','</span>');?>
          </div>
           
          <div class="form-group">
          <label>Description / rules</label>
            <textarea name="rulez" id="subject_textarea" rows="6" class="form-control" placeholder=""><?=set_value('rulez');?></textarea>
            <?=form_error('rulez','<span class="text-danger">','</span>');?>
          </div>
