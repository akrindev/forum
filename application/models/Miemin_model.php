...
class Miemin_model extends CI_Model {
  ...
  {
    return $this->db->query("Select f.id as tlid,f.id_user,f.judul,f.slug,f.isi,f.date,f.dilihat,u.id,u.username from $tabel as f inner join users as u where f.id_user = u.id order by date desc limit 10");
  }
